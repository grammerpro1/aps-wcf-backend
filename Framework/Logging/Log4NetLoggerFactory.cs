    ...
    public class Log4NetLoggerFactory : LoggerFactory
    {
        ...
        public override ILogger GetInstance(string name)
        {
            if (!_configured)
            {
                ...
                {
                    Console.WriteLine("Entro Log4NetLoggerFactory!");
                    configFile = ConfigurationManager.AppSettings["Log4netFile"];
                    //configFile = "C:\\Users\\Apa\\Downloads\\Entrega 2\\APIWcf\\APIWcf\\APIWcf.dll.log4net"; 
                    //configFile = "C:\\Users\\Apa\\Downloads\\Entrega 2\\APIWcf\\APIWcf\\APIWcf.dll.log4net";
                    //configFile = "C:\\Users\\Apa\\Documents\\Visual Studio 2017\\Proyectos\\WinCliente\\WinCliente\\bin\\Debug\\Trx.dll.log4net";
